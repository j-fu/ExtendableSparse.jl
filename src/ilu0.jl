...
"""
function ILU0Preconditioner(; valuetype::Type = Float64, indextype::Type = Int64)
    ILU0Preconditioner{valuetype, indextype}()
end
...
function LinearAlgebra.ldiv!(u::AbstractArray{T, 1},
                             precon::ILU0Preconditioner{Tv, Ti},
                             v::AbstractArray{T, 1}) where {T, Tv, Ti}
    cscmatrix = precon.A.cscmatrix
    colptr = cscmatrix.colptr
    rowval = cscmatrix.rowval
    n = cscmatrix.n
